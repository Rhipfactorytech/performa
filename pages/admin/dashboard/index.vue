    ...
    <v-row justify="center" align="center" class="mt-10">
          ...
          <v-row justify="center" align="center" class="">
            <v-col>
              <div class="text-center">
                Click on the item below to begin your setup processs <br />
        ...
        <!--  <v-row justify="center" align="center" class="mb-2 mt-6">
           ...
           <v-btn class="text-capitalize " text>
             <v-icon class="ml-n14">mdi-plus</v-icon>
             add stream</v-btn>
           ...
           <v-btn class="text-capitalize" text>
              <v-icon class="ml-3">mdi-plus</v-icon>add knowledge area</v-btn>
          
            
          </v-row> -->
          <v-row justify="center" align="center" class="mb-2">
           
           <v-btn class="text-capitalize" outlined to="/admin/dashboard/coach">
              coach</v-btn>
           ...
           <v-btn class="text-capitalize" outlined to="/admin/dashboard/partner">
              partner</v-btn>
