      ...
      <v-row>
        <v-col>
          <v-btn text class="text-capitalize mb-2" @click="dialog = true">
            ...
            <span class="titl-fnt"> add a new update </span>
          </v-btn>
        </v-col>
      </v-row>
      <v-simple-table>
        <template v-slot:default>
          <thead>
            <tr class="titl-fnt-mb-b3">
              ...
              <th class="text-left">
                <span class="titl-fnt-mb-b3">Entry </span>
              </th>
              <th class="text-left">
                <span class="titl-fnt-mb-b3"> Feedback </span>
              </th>
              <th class="text-left">
    ...
    async getmessages() {
      try {
        const res = await this.$axios.$get(
          `${this.$config.baseUrl}partner/weeklyupdate/getall`
        )
        console.log(res)
