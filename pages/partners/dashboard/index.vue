    ...
    <v-row justify="center" align="center" class="mt-10">
      <v-card height="550" width="600">
        ...
        <v-row justify="center" align="center" class="mb-2 mt-6">
          <v-btn class="text-capitalize" outlined to="/partners/dashboard/check-ins"> check-ins</v-btn>
        </v-row>
        <v-row justify="center" align="center" class="mb-2">
          <v-btn class="text-capitalize" outlined to="/partners/dashboard/profile"> Profile</v-btn>
        </v-row>
      </v-card>
    </v-row>
  </div>
